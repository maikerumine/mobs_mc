...
--mobs:register_spawn("mobs_mc:horseskeleton", {"default:dirt_with_dry_grass","es:strange_grass","es:aiden_grass"}, 20, 12, 21000, 1, 12)
--mobs:register_spawn("mobs_mc:horseskeleton", {"default:dirt_with_dry_grass"}, 20, 12, 23000, 1, 31000)
--mobs:register_spawn("mobs_mc:horseskeleton", {"default:desert_sand"}, 20, 8, 17000, 1, 5)
